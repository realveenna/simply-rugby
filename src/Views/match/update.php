    ...
    <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto lg:py-0">
        <div class="<?= cardClass() ?>">
          ...
          <form class="<?= formClass() ?>" method="post" action="">
            ...
            <!-- Squad Select -->
            <div>
                <input type="hidden" name="squad_id" value="<?= $match->squad_id ?>">
                <label for="squad_id" class="<?= labelClass() ?>">Squad Name </label>
                <select class="<?= inputClass() ?>" 
                    autocomplete="squad_id" disabled>
                    <option value="<?= $match->squad_id ?>" disabled selected>
                    <?= $match->squad_name ?></option>
                </select>
            ...
            <div class="grid gap-2 mb-6 md:grid-cols-2">
                   <!-- Submit Button -->
                    <button type="submit" name="updateMatch" value="submit" 
                        class="<?=dangerBtn()?>">
                        Delete Match
                    </button>
